...
for file in os.listdir(path)[1:]:
    print(path+str(file))
    databrut = arff.loadarff(open(path+str(file), 'r'))
    ...
    # - pour t2=t[:,1] --> [2, 4, 6, 8]
    print("---------------------------------------")
    print("Récupérer les données initiales            "+ str(file))
    ...
    plt.title("Donnees initiales : "+ str(file))
    plt.savefig(path_out+"Plot-kmeans-code1-"+str(file)+"-init.jpg",bbox_inches='tight', pad_inches=0.1)
    #plt.show()